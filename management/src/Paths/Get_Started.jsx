  ...
  return (
    <section>
        <section className='size mx-auto' style={{margin:"130px 0", maxWidth:"1000px"}}>
          ...
          <form onSubmit={handleSubmit} className='size d-flex flex-column align-items-center py-5 rounded-3 px-0' style={{margin:"100px auto 0", maxWidth:"500px", background:'#060C19', border:"1px solid #1c376dff"}}>
